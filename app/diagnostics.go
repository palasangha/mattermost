...
func (a *App) trackConfig() {
	...
	a.SendDiagnostic(TRACK_CONFIG_SERVICE, map[string]interface{}{
		...
		"session_web_timeout_minutes":                             *cfg.SessionSettings.WebTimeoutMinutes,
		"session_web_renewal_timeout_minutes":                     *cfg.SessionSettings.WebRenewalTimeoutMinutes,
		"session_web_idle_timeout_minutes":                        *cfg.SessionSettings.WebIdleTimeoutMinutes,
		"session_mobile_timeout_minutes":                          *cfg.SessionSettings.MobileTimeoutMinutes,
		"session_mobile_renewal_timeout_minutes":                  *cfg.SessionSettings.MobileRenewalTimeoutMinutes,
		"session_oauth_timeout_minutes":                           *cfg.SessionSettings.OAuthTimeoutMinutes,
